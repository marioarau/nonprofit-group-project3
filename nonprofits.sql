...
CREATE TABLE `nonprofits` (
  ...
  PRIMARY KEY (`id`),
  KEY `UserId` (`UserId`),
  CONSTRAINT `nonprofits_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
-- Dump completed on 2019-11-13 21:05:43
